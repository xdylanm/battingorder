...
Defines the structural zone-rotation algorithm for generating game lineups. Players rotate between infield and outfield zones across innings, with season balance counters used to prioritise who gets outfield time. Replaces the previous scoring-based greedy approach.
